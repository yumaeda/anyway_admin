...
class UrlUtility
{
    constructor()
    {
        if (!UrlUtility.instance)
        {
            UrlUtility.instance = this;
        }

        return UrlUtility.instance;
    }
    ...
    _generateFolderName(str, strCountry)
    {
        ...
        if (str)
        {
            strName = str.toLowerCase();
            strName = this._removeDiacritics(strName);
